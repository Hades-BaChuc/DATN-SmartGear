...
@section('content')
@php($items = $items ?? [
['id'=>1,'title'=>'Dune','author'=>'Frank Herbert','price'=>189000,'qty'=>1,'cover'=>'https://images.unsplash.com/photo-1544947950-fa07a98d237f?q=80&w=400&auto=format&fit=crop'],
['id'=>2,'title'=>'Atomic Habits','author'=>'James Clear','price'=>159000,'qty'=>2,'cover'=>'https://images.unsplash.com/photo-1524995997946-a1c2e315a42f?q=80&w=400&auto=format&fit=crop'],
])
...
<thead><tr><th>Sách</th><th class="text-center">Số lượng</th><th class="text-end">Đơn giá</th><th class="text-end">Thành tiền</th><th></th></tr></thead>
<tbody>
@foreach($items as $it)
<tr>
<td>
<div class="d-flex align-items-center gap-3">
<img class="rounded border" width="48" height="64" src="{{ $it['cover'] }}" alt="{{ $it['title'] }}">
<div>
